<template>
  <header :class="headerClass" :style="headerStyle">
    ...
    <div class="absolute inset-0" :class="bgClass" :style="bgImageStyle"></div>
    ...
    <!-- Scroll Indicator -->
    <div v-if="fullScreen" class="scroll-indicator" :style="scrollIndicatorStyle">
...
const bgImageStyle = computed(() => {
  const scale = props.enableScrollEffects ? 1 + (props.maxScale - 1) * scrollProgress.value : 1
